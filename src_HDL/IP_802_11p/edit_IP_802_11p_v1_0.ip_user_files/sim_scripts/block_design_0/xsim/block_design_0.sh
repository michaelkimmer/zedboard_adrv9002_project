...
#
# Script generated by Vivado on Sat Apr 06 17:42:06 +0200 2024
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot block_design_0 xil_defaultlib.block_design_0 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim block_design_0 -key {Behavioral:sim_1:Functional:block_design_0} -tclbatch cmd.tcl -protoinst "protoinst_files/block_design_rotation.protoinst" -protoinst "protoinst_files/block_design_atan.protoinst" -protoinst "protoinst_files/block_design_fft.protoinst" -protoinst "protoinst_files/block_design_0.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb block_design_0.wdb xsim.dir libdpi.so)
