...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L xbip_utils_v3_0_12 -L axi_utils_v2_0_8 -L c_reg_fd_v12_0_8 -L xbip_dsp48_wrapper_v3_0_5 -L xbip_pipe_v3_0_8 -L xbip_dsp48_addsub_v3_0_8 -L xbip_addsub_v3_0_8 -L c_addsub_v12_0_17 -L c_mux_bit_v12_0_8 -L c_shift_ram_v12_0_16 -L xbip_bram18k_v3_0_8 -L mult_gen_v12_0_20 -L cmpy_v6_0_23 -L floating_point_v7_0_22 -L xfft_v9_1_11 -L cordic_v6_0_21 -L secureip -L xpm --snapshot block_design_0 xil_defaultlib.block_design_0 -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim block_design_0 -key {Behavioral:sim_1:Functional:block_design_0} -tclbatch cmd.tcl -protoinst "protoinst_files/block_design_0.protoinst" -log simulate.log
}
