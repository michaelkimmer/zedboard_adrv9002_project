...
#
# Script generated by Vivado on Sat Apr 06 17:44:19 +0200 2024
# SW Build 4126759 on Thu Feb  8 23:53:51 MST 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : block_design_atan.sh
...
#
# Usage        : block_design_atan.sh
#                block_design_atan.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                block_design_atan.sh [-reset_run]
#                block_design_atan.sh [-reset_log]
#                block_design_atan.sh [-help]
#
...
#                script (type 'block_design_atan.sh -help' for more information).
#
...
design_libs_elab="-libname xpm -libname xbip_utils_v3_0_12 -libname c_reg_fd_v12_0_8 -libname xbip_dsp48_wrapper_v3_0_5 -libname xbip_pipe_v3_0_8 -libname xbip_dsp48_addsub_v3_0_8 -libname xbip_addsub_v3_0_8 -libname c_addsub_v12_0_17 -libname xbip_bram18k_v3_0_8 -libname mult_gen_v12_0_20 -libname axi_utils_v2_0_8 -libname cordic_v6_0_21 -libname xil_defaultlib -libname unisims_ver -libname unimacro_ver -libname secureip"

# set design libraries
design_libs=(simprims_ver xpm xbip_utils_v3_0_12 c_reg_fd_v12_0_8 xbip_dsp48_wrapper_v3_0_5 xbip_pipe_v3_0_8 xbip_dsp48_addsub_v3_0_8 xbip_addsub_v3_0_8 c_addsub_v12_0_17 xbip_bram18k_v3_0_8 mult_gen_v12_0_20 axi_utils_v2_0_8 cordic_v6_0_21 xil_defaultlib)

# simulation root library directory
sim_lib_dir="xcelium_lib"

# script info
echo -e "block_design_atan.sh - Script generated by export_simulation (Vivado v2023.2.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./block_design_atan.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.block_design_atan xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.block_design_atan -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log block_design_atan_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./block_design_atan.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: block_design_atan.sh [-help]\n\
Usage: block_design_atan.sh [-step]\n\
Usage: block_design_atan.sh [-lib_map_path]\n\
Usage: block_design_atan.sh [-reset_run]\n\
Usage: block_design_atan.sh [-reset_log]\n\
Usage: block_design_atan.sh [-keep_index]\n\
Usage: block_design_atan.sh [-noclean_files]\n\n\
