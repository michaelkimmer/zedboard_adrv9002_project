...
design_libs=(xpm xbip_utils_v3_0_12 c_reg_fd_v12_0_8 xbip_dsp48_wrapper_v3_0_5 xbip_pipe_v3_0_8 xbip_dsp48_addsub_v3_0_8 xbip_addsub_v3_0_8 c_addsub_v12_0_17 xbip_bram18k_v3_0_8 mult_gen_v12_0_20 axi_utils_v2_0_8 cordic_v6_0_21 xil_defaultlib)
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.block_design_atan xil_defaultlib.glbl -o block_design_atan_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./block_design_atan_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key block_design_atan_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc block_design_atan_simv.daidir vcs_lib c.obj)
