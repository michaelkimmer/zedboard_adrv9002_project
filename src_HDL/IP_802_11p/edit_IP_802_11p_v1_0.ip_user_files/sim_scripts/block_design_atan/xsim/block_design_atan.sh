...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xbip_utils_v3_0_12 -L c_reg_fd_v12_0_8 -L xbip_dsp48_wrapper_v3_0_5 -L xbip_pipe_v3_0_8 -L xbip_dsp48_addsub_v3_0_8 -L xbip_addsub_v3_0_8 -L c_addsub_v12_0_17 -L xbip_bram18k_v3_0_8 -L mult_gen_v12_0_20 -L axi_utils_v2_0_8 -L cordic_v6_0_21 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot block_design_atan xil_defaultlib.block_design_atan xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim block_design_atan -key {Behavioral:sim_1:Functional:block_design_atan} -tclbatch cmd.tcl -protoinst "protoinst_files/block_design_rotation.protoinst" -protoinst "protoinst_files/block_design_atan.protoinst" -protoinst "protoinst_files/block_design_fft.protoinst" -protoinst "protoinst_files/block_design_0.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb block_design_atan.wdb xsim.dir libdpi.so)
