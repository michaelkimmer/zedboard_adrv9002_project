...
architecture STRUCTURE of block_design_0_atan_constellation_b_0_0_atan_constellation_block is
  ...
  attribute SOFT_HLUTNM of ATAN_CONSTELLATION_PHASE_OUT_STROBE_i_1 : label is "soft_lutpair0";
...
begin
\ATAN_CONSTELLATION_AMPLITUDE_OUT_reg[0]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
\ATAN_CONSTELLATION_AMPLITUDE_OUT_reg[10]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
\ATAN_CONSTELLATION_AMPLITUDE_OUT_reg[11]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
\ATAN_CONSTELLATION_AMPLITUDE_OUT_reg[12]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
\ATAN_CONSTELLATION_AMPLITUDE_OUT_reg[13]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
\ATAN_CONSTELLATION_AMPLITUDE_OUT_reg[14]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
\ATAN_CONSTELLATION_AMPLITUDE_OUT_reg[15]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
\ATAN_CONSTELLATION_AMPLITUDE_OUT_reg[16]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
\ATAN_CONSTELLATION_AMPLITUDE_OUT_reg[17]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
\ATAN_CONSTELLATION_AMPLITUDE_OUT_reg[18]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
\ATAN_CONSTELLATION_AMPLITUDE_OUT_reg[19]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
\ATAN_CONSTELLATION_AMPLITUDE_OUT_reg[1]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
\ATAN_CONSTELLATION_AMPLITUDE_OUT_reg[20]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
\ATAN_CONSTELLATION_AMPLITUDE_OUT_reg[21]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
\ATAN_CONSTELLATION_AMPLITUDE_OUT_reg[22]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
\ATAN_CONSTELLATION_AMPLITUDE_OUT_reg[23]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
\ATAN_CONSTELLATION_AMPLITUDE_OUT_reg[2]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
\ATAN_CONSTELLATION_AMPLITUDE_OUT_reg[3]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
\ATAN_CONSTELLATION_AMPLITUDE_OUT_reg[4]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
\ATAN_CONSTELLATION_AMPLITUDE_OUT_reg[5]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
\ATAN_CONSTELLATION_AMPLITUDE_OUT_reg[6]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
\ATAN_CONSTELLATION_AMPLITUDE_OUT_reg[7]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
\ATAN_CONSTELLATION_AMPLITUDE_OUT_reg[8]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
\ATAN_CONSTELLATION_AMPLITUDE_OUT_reg[9]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
