...
\ATAN_CONSTELLATION_PHASE_OUT_CNTR_reg[0]\: unisim.vcomponents.FDCE
    generic map(
      INIT => '0'
    )
        port map (
...
\ATAN_CONSTELLATION_PHASE_OUT_CNTR_reg[1]\: unisim.vcomponents.FDCE
    generic map(
      INIT => '0'
    )
        port map (
...
\ATAN_CONSTELLATION_PHASE_OUT_CNTR_reg[2]\: unisim.vcomponents.FDCE
    generic map(
      INIT => '0'
    )
        port map (
...
\ATAN_CONSTELLATION_PHASE_OUT_CNTR_reg[3]\: unisim.vcomponents.FDCE
    generic map(
      INIT => '0'
    )
        port map (
...
\ATAN_CONSTELLATION_PHASE_OUT_CNTR_reg[4]\: unisim.vcomponents.FDCE
    generic map(
      INIT => '0'
    )
        port map (
...
\ATAN_CONSTELLATION_PHASE_OUT_CNTR_reg[5]\: unisim.vcomponents.FDCE
    generic map(
      INIT => '0'
    )
        port map (
...
ATAN_CONSTELLATION_PHASE_OUT_STROBE_reg: unisim.vcomponents.FDCE
    generic map(
      INIT => '0'
    )
        port map (
...
\ATAN_CONSTELLATION_PHASE_OUT_reg[0]\: unisim.vcomponents.FDCE
    generic map(
      INIT => '0'
    )
        port map (
...
\ATAN_CONSTELLATION_PHASE_OUT_reg[10]\: unisim.vcomponents.FDCE
    generic map(
      INIT => '0'
    )
        port map (
...
\ATAN_CONSTELLATION_PHASE_OUT_reg[11]\: unisim.vcomponents.FDCE
    generic map(
      INIT => '0'
    )
        port map (
...
\ATAN_CONSTELLATION_PHASE_OUT_reg[12]\: unisim.vcomponents.FDCE
    generic map(
      INIT => '0'
    )
        port map (
...
\ATAN_CONSTELLATION_PHASE_OUT_reg[13]\: unisim.vcomponents.FDCE
    generic map(
      INIT => '0'
    )
        port map (
...
\ATAN_CONSTELLATION_PHASE_OUT_reg[14]\: unisim.vcomponents.FDCE
    generic map(
      INIT => '0'
    )
        port map (
...
\ATAN_CONSTELLATION_PHASE_OUT_reg[15]\: unisim.vcomponents.FDCE
    generic map(
      INIT => '0'
    )
        port map (
...
\ATAN_CONSTELLATION_PHASE_OUT_reg[16]\: unisim.vcomponents.FDCE
    generic map(
      INIT => '0'
    )
        port map (
...
\ATAN_CONSTELLATION_PHASE_OUT_reg[17]\: unisim.vcomponents.FDCE
    generic map(
      INIT => '0'
    )
        port map (
...
\ATAN_CONSTELLATION_PHASE_OUT_reg[18]\: unisim.vcomponents.FDCE
    generic map(
      INIT => '0'
    )
        port map (
...
\ATAN_CONSTELLATION_PHASE_OUT_reg[19]\: unisim.vcomponents.FDCE
    generic map(
      INIT => '0'
    )
        port map (
...
\ATAN_CONSTELLATION_PHASE_OUT_reg[1]\: unisim.vcomponents.FDCE
    generic map(
      INIT => '0'
    )
        port map (
...
\ATAN_CONSTELLATION_PHASE_OUT_reg[20]\: unisim.vcomponents.FDCE
    generic map(
      INIT => '0'
    )
        port map (
...
\ATAN_CONSTELLATION_PHASE_OUT_reg[21]\: unisim.vcomponents.FDCE
    generic map(
      INIT => '0'
    )
        port map (
...
\ATAN_CONSTELLATION_PHASE_OUT_reg[22]\: unisim.vcomponents.FDCE
    generic map(
      INIT => '0'
    )
        port map (
...
\ATAN_CONSTELLATION_PHASE_OUT_reg[23]\: unisim.vcomponents.FDCE
    generic map(
      INIT => '0'
    )
        port map (
...
\ATAN_CONSTELLATION_PHASE_OUT_reg[2]\: unisim.vcomponents.FDCE
    generic map(
      INIT => '0'
    )
        port map (
...
\ATAN_CONSTELLATION_PHASE_OUT_reg[3]\: unisim.vcomponents.FDCE
    generic map(
      INIT => '0'
    )
        port map (
...
\ATAN_CONSTELLATION_PHASE_OUT_reg[4]\: unisim.vcomponents.FDCE
    generic map(
      INIT => '0'
    )
        port map (
...
\ATAN_CONSTELLATION_PHASE_OUT_reg[5]\: unisim.vcomponents.FDCE
    generic map(
      INIT => '0'
    )
        port map (
...
\ATAN_CONSTELLATION_PHASE_OUT_reg[6]\: unisim.vcomponents.FDCE
    generic map(
      INIT => '0'
    )
        port map (
...
\ATAN_CONSTELLATION_PHASE_OUT_reg[7]\: unisim.vcomponents.FDCE
    generic map(
      INIT => '0'
    )
        port map (
...
\ATAN_CONSTELLATION_PHASE_OUT_reg[8]\: unisim.vcomponents.FDCE
    generic map(
      INIT => '0'
    )
        port map (
...
\ATAN_CONSTELLATION_PHASE_OUT_reg[9]\: unisim.vcomponents.FDCE
    generic map(
      INIT => '0'
    )
        port map (
...
\S_AXIS_CARTESIAN_tuser_reg[0]\: unisim.vcomponents.FDCE
    generic map(
      INIT => '0'
    )
        port map (
...
\S_AXIS_CARTESIAN_tuser_reg[1]\: unisim.vcomponents.FDCE
    generic map(
      INIT => '0'
    )
        port map (
...
\S_AXIS_CARTESIAN_tuser_reg[2]\: unisim.vcomponents.FDCE
    generic map(
      INIT => '0'
    )
        port map (
...
\S_AXIS_CARTESIAN_tuser_reg[3]\: unisim.vcomponents.FDCE
    generic map(
      INIT => '0'
    )
        port map (
...
\S_AXIS_CARTESIAN_tuser_reg[4]\: unisim.vcomponents.FDCE
    generic map(
      INIT => '0'
    )
        port map (
...
\S_AXIS_CARTESIAN_tuser_reg[5]\: unisim.vcomponents.FDCE
    generic map(
      INIT => '0'
    )
        port map (
