...
module block_design_0_fft_ofdm_0_1(RESET, CLOCK, FFT_IDATA_IN, FFT_QDATA_IN, 
  FFT_DATA_IN_STROBE, FFT_DATA_IN_START, FFT_IDATA_OUT, FFT_QDATA_OUT, FFT_DATA_OUT_VALID, 
  FFT_DATA_OUT_LAST, M_AXIS_DATA_tdata, M_AXIS_DATA_tlast, M_AXIS_DATA_tvalid, 
  S_AXIS_CONFIG_tdata, S_AXIS_CONFIG_tready, S_AXIS_CONFIG_tvalid, S_AXIS_DATA_tdata, 
  S_AXIS_DATA_tlast, S_AXIS_DATA_tready, S_AXIS_DATA_tvalid, aclk, aresetn)
/* synthesis syn_black_box black_box_pad_pin="RESET,FFT_IDATA_IN[15:0],FFT_QDATA_IN[15:0],FFT_DATA_IN_STROBE,FFT_DATA_IN_START,FFT_IDATA_OUT[23:0],FFT_QDATA_OUT[23:0],FFT_DATA_OUT_VALID,FFT_DATA_OUT_LAST,M_AXIS_DATA_tdata[47:0],M_AXIS_DATA_tlast,M_AXIS_DATA_tvalid,S_AXIS_CONFIG_tdata[7:0],S_AXIS_CONFIG_tready,S_AXIS_CONFIG_tvalid,S_AXIS_DATA_tdata[31:0],S_AXIS_DATA_tlast,S_AXIS_DATA_tready,S_AXIS_DATA_tvalid,aresetn" */
