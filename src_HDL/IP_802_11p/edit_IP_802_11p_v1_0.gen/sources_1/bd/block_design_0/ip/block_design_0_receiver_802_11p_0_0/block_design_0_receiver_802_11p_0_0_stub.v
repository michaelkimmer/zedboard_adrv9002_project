...
module block_design_0_receiver_802_11p_0_0(RESET, CLOCK, IDATA_IN, QDATA_IN, DATA_IN_STROBE, 
  ...
  FPGA_REG_WRITE_DATA, ATAN_AUTOCORR_STROBE, ATAN_AUTOCORR_I, ATAN_AUTOCORR_Q, 
  ...
  FFT_QDATA_IN, FFT_DATA_IN_STROBE, FFT_DATA_IN_START, FFT_IDATA_OUT, FFT_QDATA_OUT, 
  FFT_DATA_OUT_VALID, FFT_DATA_OUT_LAST)
/* synthesis syn_black_box black_box_pad_pin="RESET,IDATA_IN[15:0],QDATA_IN[15:0],DATA_IN_STROBE,DETECTION_STROBE,DETECTION_SIGNAL_DETECTED,DETECTION_STS_AUTOCORR_I[31:0],DETECTION_STS_AUTOCORR_Q[31:0],FPGA_REG_WRITE_STROBE,FPGA_REG_WRITE_ADDRESS[8:0],FPGA_REG_WRITE_DATA[31:0],ATAN_AUTOCORR_STROBE,ATAN_AUTOCORR_I[31:0],ATAN_AUTOCORR_Q[31:0],ATAN_PHASE_OUT_STROBE,ATAN_PHASE_OUT[15:0],ROTATION_DATA_IN_STROBE,ROTATION_DATA_IN_MARKER,ROTATION_IDATA_IN[15:0],ROTATION_QDATA_IN[15:0],ROTATION_PHASE_NEW_DIFF_STROBE,ROTATION_PHASE_NEW_DIFF[15:0],ROTATION_DATA_OUT_STROBE,ROTATION_DATA_OUT_MARKER,ROTATION_IDATA_OUT[15:0],ROTATION_QDATA_OUT[15:0],FFT_IDATA_IN[15:0],FFT_QDATA_IN[15:0],FFT_DATA_IN_STROBE,FFT_DATA_IN_START,FFT_IDATA_OUT[23:0],FFT_QDATA_OUT[23:0],FFT_DATA_OUT_VALID,FFT_DATA_OUT_LAST" */
/* synthesis syn_force_seq_prim="CLOCK" */;
  ...
  input [23:0]FFT_IDATA_OUT;
  input [23:0]FFT_QDATA_OUT;
  input FFT_DATA_OUT_VALID;
  input FFT_DATA_OUT_LAST;
endmodule
