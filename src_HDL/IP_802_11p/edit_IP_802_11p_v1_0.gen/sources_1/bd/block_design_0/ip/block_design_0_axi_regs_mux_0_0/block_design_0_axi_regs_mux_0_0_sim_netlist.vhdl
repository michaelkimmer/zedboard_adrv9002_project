...
architecture STRUCTURE of block_design_0_axi_regs_mux_0_0_axi_regs_mux is
  ...
  signal \FPGA_REG_WRITE_ADDRESS[1]_i_2_n_0\ : STD_LOGIC;
  signal \FPGA_REG_WRITE_ADDRESS[1]_i_3_n_0\ : STD_LOGIC;
  signal \FPGA_REG_WRITE_ADDRESS[2]_i_1_n_0\ : STD_LOGIC;
  signal \FPGA_REG_WRITE_ADDRESS[2]_i_2_n_0\ : STD_LOGIC;
  signal \FPGA_REG_WRITE_ADDRESS[2]_i_3_n_0\ : STD_LOGIC;
  ...
  signal \FPGA_REG_WRITE_ADDRESS[5]_i_2_n_0\ : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of \ADDRESS_COUNTER[1]_i_1\ : label is "soft_lutpair0";
  ...
  attribute SOFT_HLUTNM of \ADDRESS_COUNTER[6]_i_1\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \FPGA_REG_WRITE_ADDRESS[2]_i_3\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \FPGA_REG_WRITE_ADDRESS[5]_i_2\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \FPGA_REG_WRITE_ADDRESS[8]_i_3\ : label is "soft_lutpair1";
  ...
  attribute SOFT_HLUTNM of \FPGA_REG_WRITE_DATA[31]_i_5\ : label is "soft_lutpair3";
...
\ADDRESS_COUNTER[7]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"00000000AAAA6AAA"
    )
        port map (
...
\FPGA_REG_WRITE_ADDRESS[1]_i_2\: unisim.vcomponents.LUT6
    generic map(
...
\FPGA_REG_WRITE_ADDRESS[1]_i_3\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"0000000022C00000"
    )
        port map (
      I0 => FFT_DATA_VALID,
...
\FPGA_REG_WRITE_ADDRESS[2]_i_3\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"20882000"
    )
        port map (
...
\FPGA_REG_WRITE_ADDRESS[5]_i_2\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"7FFFFFFF"
    )
        port map (
...
\FPGA_REG_WRITE_ADDRESS[8]_i_2\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"7FFF"
    )
        port map (
...
\FPGA_REG_WRITE_ADDRESS[8]_i_3\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"7"
    )
        port map (
...
\FPGA_REG_WRITE_DATA[31]_i_4\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"E"
    )
        port map (
...
\FPGA_REG_WRITE_DATA[31]_i_6\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"2"
    )
        port map (
