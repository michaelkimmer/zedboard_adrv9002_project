...
module block_design_0_axi_regs_mux_0_0(RESET, CLOCK, SELECT_AXI_REGS_MODE, 
  ...
  CONSTELLATION_IDATA, CONSTELLATION_QDATA, CONSTELLATION_DATA_VALID, 
  ...
  PARALLEL_OUTPUT_LAST, FPGA_REG_WRITE_ADDRESS, FPGA_REG_WRITE_DATA, 
  FPGA_REG_WRITE_STROBE)
/* synthesis syn_black_box black_box_pad_pin="RESET,SELECT_AXI_REGS_MODE[7:0],EQUALIZER_REG_WRITE_STROBE_PHASE_1,EQUALIZER_REG_WRITE_STROBE_PHASE_2,EQUALIZER_REG_WRITE_DATA[31:0],DATA_STROBE,IDATA[15:0],QDATA[15:0],FFT_IDATA[23:0],FFT_QDATA[23:0],FFT_DATA_VALID,CONSTELLATION_IDATA[23:0],CONSTELLATION_QDATA[23:0],CONSTELLATION_DATA_VALID,DEINTERLEAVER_STROBE,DEINTERLEAVER_BPSK[0:47],DEINTERLEAVER_QPSK[0:95],DEINTERLEAVER_16QAM[0:191],VITERBI_SIGNAL_VALID,VITERBI_SIGNAL[31:0],PARALLEL_OUTPUT_VALID,PARALLEL_OUTPUT[31:0],PARALLEL_OUTPUT_LAST,FPGA_REG_WRITE_ADDRESS[11:0],FPGA_REG_WRITE_DATA[31:0],FPGA_REG_WRITE_STROBE" */
